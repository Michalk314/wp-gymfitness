...
<section class = "welcome text-center section">
    <h2 class="text-primary"><?php the_field('welcom_heading')?></h2>
    <p><?php the_field('welcom_text'); ?></p>
    </section>
...
<section class="instructors">
    <div class="container section">
        ...
        <p class="text-center">Professional instructors thath will help you achive your goals</p>
